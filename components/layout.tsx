...
const LayOut = ({ title, hasTabBar, children }: LayoutProps) => {
    return (
        <div className="w-full max-w-xl mx-auto">
            <div className="bg-white w-full text-lg max-w-xl font-medium py-3 fixed text-gray-800 border-b top-0 justify-center flex items-center">
                {title ? <span>{title}</span> : null}
            </div>
            <div className="pt-10 pb-24">{children}</div>
            {hasTabBar &&
                <nav
