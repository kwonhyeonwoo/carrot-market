...
export default function Profile() {
    return (
        // 프로필에 나중에 회원 닉네임이 들어가야함
        <LayOut title='프로필' hasTabBar>
            <div className="py-10 px-4">
                <div className="flex items-center space-x-4">
                    <div className="bg-slate-500 w-14 h-14 rounded-full" />
                    <div className="flex flex-col">
                        <span className="font-bold text-gray-700">Steve Jebs</span>
                        <span className=" text-sm text-gray-600">Edit profile &rarr;</span>
                    </div>
                </div>
                <div className="flex mt-10 items-center justify-around">
                    <div className="">
                        ...
                        <span className="text-sm text-gray-600">판매내역</span>
                    </div>
                    <div>
                        <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center text-white mb-2">
                            <svg
                        ...
                        <span className="text-sm text-gray-600">구매내역</span>
                    </div>
                    <div>
                        <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center text-white mb-2">
                            <svg
